...
`)+`
`+p);let w=b+m+o,M=b+p+a,I=yE(r,r.VERTEX_SHADER,w),E=yE(r,r.FRAGMENT_SHADER,M);r.attachShader(y,I),r.attachShader(y,E),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function D(C){if(n.debug.checkShaderErrors){let k=r.getProgramInfoLog(y)||"",G=r.getShaderInfoLog(I)||"",X=r.getShaderInfoLog(E)||"",O=k.trim(),z=G.trim(),U=X.trim(),Q=!0,ee=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(Q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,y,I,E);else{let ue=xE(r,I,"vertex"),xe=xE(r,E,"fragment");Re("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
